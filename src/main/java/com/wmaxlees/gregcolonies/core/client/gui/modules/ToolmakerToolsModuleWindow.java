...
import com.wmaxlees.gregcolonies.api.util.constant.TagConstants;
...
public class ToolmakerToolsModuleWindow extends AbstractModuleWindow {
     ...
     */
    public ToolmakerToolsModuleWindow(final IBuildingView building, final ToolmakerToolsModuleView module) {
    ...
    private void updateToolList() {
        ...
        toolList.setDataProvider(new ScrollingList.DataProvider() {
            /**
             ...
             * @param rowPane the parent Pane for the row, containing the elements to
             *                update.
             */
            @Override
            public void updateElement(final int index, @NotNull final Pane rowPane) {
                final ItemStack item = new ItemStack((Item)ForgeRegistries.ITEMS.tags().getTag(ModTags.toolsmithLV).stream().toArray()[index]);
