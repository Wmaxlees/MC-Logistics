...
public class ToolmakerToolsModule extends AbstractBuildingModule
  ...
  public void serializeNBT(final CompoundTag compound) {
    compound.put(
        TAG_KEEP_STOCKED_LIST,
        keepStocked.entrySet().stream()
            .map(this::serializeKeepStocked)
   ...
   */
  private Tuple<ResourceLocation, Boolean> deserializeKeepStocked(
      final CompoundTag nbtTagCompound) {
